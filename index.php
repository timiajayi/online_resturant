...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/caleb/caleblogo.jpg" alt="" width="150px" height="40px"> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/caleb/caf.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Calebites Order Delivery & Take-Out </h1>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/caleb/caleblogo.jpg" alt="Footer logo" width="150px" height="40px"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: <a href="tel:+2348072135757">0807 213 5757</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>Join the other school restaurants who benefit from having their menus here</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
